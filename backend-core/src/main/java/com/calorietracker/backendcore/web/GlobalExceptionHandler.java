...
/**
 * Translates exceptions into clean JSON error responses so the JavaFX client
...
public class GlobalExceptionHandler {
    ...
    /** Method-parameter validation (e.g. @RequestParam @Min on a controller method). */
    ...
    /**
     * Last-resort handler. Without this, an unexpected exception would surface as
     * Spring's default whitelabel error which leaks the underlying exception
     * class name. We log the full stack server-side and return a plain message.
     */
